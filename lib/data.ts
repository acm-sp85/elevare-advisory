export const siteData = {
  hero: {
    title: "Making complex deals work",
    subtitle: "Helping organisations structure, execute, and stabilise complex deals — from pursuit to delivery",
    cta: "Let's Talk",
  },
  about: {
    title: "About Elevare",
